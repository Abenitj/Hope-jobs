...
const navigation = [
  ...
  { name: "Browse Jobs", href: "/seeker/jobs", icon: Search },
  { name: "My Applications", href: "/seeker/applications", icon: FileText },
  { name: "Profile", href: "/seeker/profile", icon: UserCircle },
  { name: "Messages", href: "/seeker/messages", icon: MessageSquare },
]

export function SeekerSidebar({ user }: SeekerSidebarProps) {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center h-14 px-4 border-b border-slate-200 dark:border-slate-800">
            <Link href="/seeker/dashboard" className="flex items-center space-x-2 group">
